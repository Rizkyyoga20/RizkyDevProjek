...
const ListSearch = computed(() => {
  ...
  SearchData.value = store.Menus1.filter(
...
//https://ni4yja.medium.com/how-to-filter-todo-items-vue-3-composition-api-d4cf69cf056
//state pinia
...
class="
  ...
  m-2
"
v-for="List1 in SearchData"
>
  <a href="#"></a>
  <div class="relative"><a href="#">
          <img :src=List1.strMealThumb
            class="w-full"  
            alt="Product">
          <div
              class="
  ...
  <div class="px-6 
      ...
      >
          ...
          <span class="ml-1">{{ List1.idMeal }} Stok</span>
      </span>
      
        <span class="ml-1">
          <a :href="'https://api.whatsapp.com/send?phone=+6287763578343&text=Hello, saya mau pesan '+ List1.strMeal">
