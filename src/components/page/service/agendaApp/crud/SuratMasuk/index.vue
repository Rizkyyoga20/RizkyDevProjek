...
const showSuratMasuk = ref(false)

const openSuratMasuk = () => {
  showSuratMasuk.value = true
}
...
>
    ...
    <div class="relative top-5 bottom-5">
        <div class="flex justify-end p-2">
            <button 
                @click="Modal.closeModal('modalSuratMasuk')"
                type="button" 
                class="
                    text-gray-400 
                    bg-transparent 
